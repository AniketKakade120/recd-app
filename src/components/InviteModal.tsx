      ...
      <div className="relative z-10 w-full md:max-w-md bg-surface border border-border rounded-t-3xl md:rounded-3xl p-6 overflow-hidden animate-in slide-in-from-bottom-8 duration-300">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-xl font-bold text-bone font-editorial">Assemble your crew.</h3>
              <p className="text-xs text-muted mt-1">Share your link to start sharing recommendations.</p>
            </div>
          ...
          {/* Preview Box */}
          <div className="bg-ink/40 border border-border rounded-xl p-4 mb-6 relative group">
          ...
          <button 
            onClick={onClose}
            className="w-full mt-8 py-2 text-xs text-muted hover:text-bone transition-colors font-medium"
          >
            Maybe later
          </button>
        </div>
