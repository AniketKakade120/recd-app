...
const navItems = [
  ...
  { name: 'Journal', path: '/journal', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/></svg> },
];
...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const noShell = isPublicRoute && !pathname.startsWith('/list/');
  if (noShell) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Mobile Bottom Nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 border-t border-border bg-ink/95 backdrop-blur-xl z-50 flex justify-around items-center px-2 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
