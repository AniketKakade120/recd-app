...
export const RecommendationEmail = ({
  ...
  const previewText = `${senderName} just recommended ${titleName} to you!`;
          ...
          <Container className="border border-solid border-[#ffffff1a] rounded-[24px] overflow-hidden my-[40px] mx-auto w-[465px] max-w-full bg-[#1a1a1a]">
            ...
            <Section className="px-8 py-8">
              ...
              <Text className="text-[#f5f5f0b3] text-[15px] leading-[24px] text-center mb-8">
                <strong className="text-[#ea3333]">{senderName}</strong> just dropped a recommendation for you: <strong className="text-white">{titleName}</strong>.
              </Text>
