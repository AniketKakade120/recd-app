...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-ink relative overflow-hidden">
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-cinema-red/7 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-brick/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-sm z-10">
        ...
        <p className="text-center text-xs text-muted mt-5">
          No account?{' '}
          <Link href="/signup" className="text-cinema-red hover:text-cinema-red/80">Sign up</Link>
        </p>
      </div>
    </div>
  );
